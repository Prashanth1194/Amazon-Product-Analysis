...
#r = reactiveValues()
      ...
      r <- reactive({
        ...
        prod_code = input$id
        #prod_code = "B01LPY9R08"
        print(input$url)
        a = ifelse(input$url=="one" ,"https://www.amazon.in/dp/product/", "https://www.amazon.in/gp/product/")
        print("A is")
        print(a)
        #url <- paste0("https://www.amazon.in/dp/product/")
        #a = url
        print(a)
      ...
      output$table1 <- renderDataTable({
       ...
       # reviews_all = r()
        ...
        output$hcontainer <- renderHighchart({      
          ...
          #tt = r()
          tt1 = sqldf("select stars,count(stars) as count,count(stars) as helpful from tt group by stars")
          ...
          highchart() %>% 
            ...
            # hc_yAxis(
            #   list(title = list(text = "Frequency of Rating"),min=0)) %>%
